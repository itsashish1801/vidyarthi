  ...
  return (
    <Container className='pb-16 pt-20 text-center lg:pt-32'>
      ...
      <p className='mx-auto mt-6 max-w-3xl text-lg tracking-tight text-slate-700'>
        Welcome to the AICTE Curriculum Collaboration Portal, where we unite
        experts to shape India's technical education future, crafting a model
        curriculum for excellence. Join us in this transformative journey to
        empower the next generation of India.
      </p>
      ...
      <div className='mt-36 lg:mt-44'>
        <p className='font-display text-base text-slate-900'>
          Trusted by these top colleges so far
        </p>
        <ul
          role='list'
        ...
        >
          {[
            [
              { name: 'Transistor', logo: logo1 },
              { name: 'Tuple', logo: logo2 },
              { name: 'StaticKit', logo: logo3 },
            ],
            [
              { name: 'Mirage', logo: logo4 },
              { name: 'Laravel', logo: logo5 },
              { name: 'Statamic', logo: logo6 },
            ],
